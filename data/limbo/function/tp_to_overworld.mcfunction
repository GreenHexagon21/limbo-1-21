...
execute in minecraft:overworld run setblock ~-1 ~1 ~-1 structure_block[mode=load]{name:"limbo:portal_small",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute in minecraft:overworld run setblock ~-1 ~2 ~-1 redstone_block replace
